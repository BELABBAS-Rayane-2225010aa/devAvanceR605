...
final class Version20250204104002 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE qcm (id INT AUTO_INCREMENT NOT NULL, theme VARCHAR(50) NOT NULL, name VARCHAR(50) NOT NULL, questions COLLECTION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
